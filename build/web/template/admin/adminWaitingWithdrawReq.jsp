...
<html>
    ...
    <body>
        <div class="container" style="margin-left: 250px; margin-top: 75px;">
            <H4 class="text-center" style="margin-top: 6rem;">WAITING WITHDRAWAL</H4><br>
            ...
            <table class="table table-hover table-bordered table-striped">
                ...
                <tbody>
                    <%
                        ...
                        String query = "select id, name, age, reason, bloodgroup, unit, reqdate, status from blood_request_list_tb where status='Approved'";
                        ...
                        if (set.next()) {
                            do {
                                ...
                                out.println("<form id='approvalForm' action='../../patientBloodStockUpdater' method='post'>");
                                ...
                                out.println("<button type='submit' class='btn btn-success badge-pill'>Withdraw</button>");
                                out.println("</form></td>");
                                out.println("</tr>");
                            } while (set.next());
                        } else {
                            out.println("<tr><td colspan='8' class='text-center'>No Blood Withdraw Request Found !</td></tr>");
                        }
                    %>
                </tbody>
            </table>
